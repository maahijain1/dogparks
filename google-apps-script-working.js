// Simple version that works without UI context issues
function onOpen() {
  // This function will be called automatically when the sheet opens
  // The menu will be created when any function is first run
}
